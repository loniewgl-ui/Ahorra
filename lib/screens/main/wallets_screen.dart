...
class WalletsScreen extends StatelessWidget {
  ...
  void _deleteWallet(BuildContext context, Wallet wallet) async {
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: const Text('Delete Wallet'),
        content: Text(
          'Are you sure you want to delete "${wallet.name}"? This will also remove all its transactions.',
        ),
        actions: [
          TextButton(
    ...
    if (confirmed == true && context.mounted) {
      context.read<AppData>().deleteWallet(wallet.id);
    }
  }
